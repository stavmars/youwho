  ...
  render() {
    ...
    return loading ? (
      ...
      <div style={{ width: '100%', backgroundColor: '#6065CC' }}>
        <ProgressBar activeCategory={activeCategory} categories={surveysByName[surveyId].topics[scenario]} />
        <ThemeProvider
          theme={{
            background: '#777EFF',
        ...
        >
          <ChatBot
            ...
            steps={configureStep(surveysByName[surveyId].questions, scenario)}
            style={{

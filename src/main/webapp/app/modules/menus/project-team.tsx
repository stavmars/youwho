        ...
        <Grid className="project-team-page" centered stackable>
          ...
          {MemberBio(
            ...
            'Διδάκτωρ του τμήματος Πολιτικής Επιστήμης και Ιστορίας του Παντείου Πανεπιστημίου με αντικείμενο μελέτης τις κοινωνικές διαιρετικές τομές της ύστερης ' +
              ...
              'ΕΚΚΕ στα πλαίσια του έργου «Δυναμική Διαχείριση Βάσεων Κοινωνικών Δεδομένων και Χαρτογραφικών Αναπαραστάσεων - Καλειδοσκόπιο Κοινωνικών Δεδομένων», ως ερευνητής ' +
              'και πολιτικός αναλυτής στον ιδιωτικό τομέα και ως δημοσιογράφος σε εφημερίδες, περιοδικά και ιστοσελίδες. Τα επιστημονικά και ερευνητικά του ενδιαφέροντα αφορούν ' +
              'τη θεωρία των διαιρετικών τομών, την εκλογική συμπεριφορά, τα πολιτικά κόμματα και τα κοινωνικά κινήματα.',

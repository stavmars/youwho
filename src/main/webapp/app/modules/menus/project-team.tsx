        ...
        <Grid className="project-team-page" centered stackable>
          ...
          {MemberBio(
            ...
            'Εντεταλμένη Ερευνήτρια στο Εθνικό Κέντρο Κοινωνικών Ερευνών, στο αντικείμενο «Πολιτική Κουλτούρα και εκλογική συμπεριφορά». Έχει συμμετάσχει σε πάνω από' +
              ...
              ' αντιπροσώπευση, στις έμφυλες σχέσεις καθώς και στην μελέτη της ταυτότητας των νέων. Μέσω της πλατφόρμας socioscope έχει εξειδικευθεί στην οπτικοποίηση και διάχυση ' +
              'των ερευνητικών αποτελεσμάτων ενώ διηύθυνε την πρώτη διαδικτυακή έρευνα που υλοποιήθηκε από το ΕΚΚΕ το 2017 με αντικείμενο την ' +
          ...
          {MemberBio(
            ...
            'Επικοινωνιολόγος και Marketer, πτυχιούχος του τμήματος ΕΜΜΕ του Πανεπιστημίου Αθηνών καθώς και κάτοχος MSc in Marketing and Communication από το ' +
              'Οικονομικό Πανεπιστήμιο Αθηνών με εξειδίκευση στο Marketing. Παράλληλα κατέχει το Professional Diploma in Digital & Social Media από το Αμερικάνικο Κολλέγιο Αθηνών.' +
              ' Στην επαγγελματική της εμπειρία συγκαταλέγονται η Εταιρική Επικοινωνία, η δημιουργία και διατήρηση μακροχρόνιων σχέσεων με πελάτες (B2B) και η δημιουργία ' +
          ...
          {MemberBio(
            ...
            'Διπλωματούχος μηχανικός της Σχολής Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του Εθνικού Μετσόβιου Πολυτεχνείου (ΕΜΠ). Το 2009 αναγορεύτηκε ' +
              ...
              'Από το 2009 είναι ερευνητικός συνεργάτης στο Ινστιτούτο Πληροφοριακών Συστημάτων του Ε.Κ. "Αθηνά". Έχει εργαστεί ως μηχανικός λογισμικού και ερευνητής σε ερευνητικά' +
              ' προγράμματα του ΕΜΠ και του ΕΠΙΣΕΥ. Υπήρξε επιστημονικός υπεύθυνος εκ μέρους του Ε.Κ. ΑΘΗΝΑ στο έργο «Sodamap - Δυναμική διαχείριση βάσεων Κοινωνικών δεδομένων και' +
              ' Χαρτογραφικών αναπαραστάσεων», πρόσκληση “ΚΡΗΠΙΣ” της ΓΓΕΤ όπου σε συνεργασία με το Εθνικό Κέντρο Κοινωνικών Ερευνών υλοποίησαν την πλατφόρμα Καλειδοσκόπιο ' +
              'Κοινωνικών Δεδομένων (www.socioscope.gr).',
          ...
          {MemberBio(
            ...
            'Διπλωματούχος μηχανικός και υποψήφιος διδάκτορας της Σχολής Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του Εθνικού Μετσόβιου Πολυτεχνείου (ΕΜΠ).' +
              ' Από το 2014 είναι ερευνητικός συνεργάτης στο Ινστιτούτο Πληροφοριακών Συστημάτων του Ε.Κ. “Αθηνά” και έχει εργασθεί ως μηχανικός λογισμικού σε πολλά ευρωπαϊκά και' +
              ' ελληνικά ερευνητικά προγράμματα. Συμμετείχε στην ανάπτυξη της πλατφόρμας www.socioscope.gr για την οπτικοποίηση και ανάλυση κοινωνικών και πολιτικών δεδομένων, ' +
              'καθώς και της ψηφιακής πλατφόρμας YouWho για τη συλλογή και διάθεση δεδομένων αποτύπωσης της ταυτότητας των νέων.',

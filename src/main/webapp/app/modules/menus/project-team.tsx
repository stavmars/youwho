        ...
        <Grid className="project-team-page" centered stackable>
          ...
          {MemberBio(
            ...
            'Κύρια Ερευνήτρια στο Εθνικό Κέντρο Κοινωνικών Ερευνών (ΕΚΚΕ) με σημαντική ερευνητική εμπειρία στην υλοποίηση ερευνητικών έργων με αντικείμενο την ' +
              'ανάπτυξη ερευνητικών υποδομών των κοινωνικών επιστημών, καθώς και τη μελέτη της κοινωνίας της πληροφορίας και των επιπτώσεων των νέων τεχνολογιών στην εργασία ' +
              'και την εκπαίδευση με έμφαση στο φύλο. Τα ερευνητικά της ενδιαφέροντα εστιάζουν επίσης σε ζητήματα μεθοδολογίας της εμπειρικής έρευνας (τεκμηρίωση ποσοτικών και ' +
              ...
              '(ΕΣΙ) του ΕΚΚΕ (2019-) και εθνικός εκπρόσωπος της Ελληνικής Ερευνητικής Υποδομής SODaNet στο Service Providers Forum (SPF) του CESSDA ERIC (Consortium of ' +
              'European Social Science Archives).',
          ...
          {MemberBio(
            ...
            'Μέλος ομάδας έργου ΕΚΚΕ (Κοινωνική Ψυχολογία)',
            'Διαθέτει εμπειρία πάνω από 20 χρόνια στην υλοποίηση προγραμμάτων και ερευνών πεδίου σε θέματα κοινωνικής πολιτικής σε εθνικό και ευρωπαϊκό επίπεδο. Η ' +
              'εξειδίκευσή της αφορά τις μεθόδους της εφαρμοσμένης κοινωνικής έρευνας και το ενδιαφέρον της επικεντρώνεται στην ψυχοκοινωνική αποκατάσταση και επαγγελματική ' +
              '(επαν-)ένταξη κοινωνικά ευάλωτων ομάδων. Μέσω της συμμετοχής της σε ποιοτικές έρευνες, έχει αποκτήσει εκτενή εμπειρία στην οργάνωση, διεξαγωγή και ανάλυση των ' +
              'δεδομένων με τη χρήση των ποιοτικών μεθόδων στην κοινωνική έρευνα (προσωπικές συνεντεύξεις, ομαδικά εστιασμένες συνεντεύξεις κλπ.). ',
          ...
          {MemberBio(
            ...
            'Επικοινωνιακός σχεδιασμός έργου – Διαχείριση Social Media  (Marketing και επικοινωνία)',
            'Επικοινωνιολόγος και Marketer, πτυχιούχος του τμήματος Επικοινωνίας και Μέσων Μαζικής Ενημέρωσης του Πανεπιστημίου Αθηνών καθώς και κάτοχος MSc in ' +
              'Marketing and Communication από το Οικονομικό Πανεπιστήμιο Αθηνών με ειδίκευση στο Marketing. Παράλληλα κατέχει το Professional Diploma in Digital & Social Media ' +
              'από το Αμερικάνικο Κολλέγιο Αθηνών. Στην επαγγελματική της εμπειρία συγκαταλέγονται η Εταιρική Επικοινωνία, η δημιουργία και διατήρηση μακροχρόνιων σχέσεων με ' +
              'πελάτες (B2B) και η δημιουργία στρατηγικών εισόδου νέων επιχειρήσεων στην αγορά. Τα επιστημονικά της ενδιαφέροντα αφορούν στο Marketing Υπηρεσιών, τη Συμπεριφορά ' +
              'Καταναλωτή online και offline καθώς και την επίδραση του Servicescape στην ικανοποίηση του καταναλωτή. Ως μέλος της Ομάδας έργου του YouWho? ανέλαβε το σχεδιασμό ' +
              'και την υλοποίηση του στρατηγικού πλάνου επικοινωνίας. Παράλληλα, ανέλαβε την επίβλεψη και τη διαχείριση των social media accounts καθώς και την παραγωγή ' +
              'περιεχομένου.',
          ...
          {MemberBio(
            'Αγγελική Καζάνη',
            'Μέλος ομάδας έργου ΕΚΚΕ (Κοινωνική Στατιστική)',
            'Μεταδιδακτορική ερευνήτρια στο Τμήμα Κοινωνικής Πολιτικής του Παντείου Πανεπιστημίου Κοινωνικών και Πολιτικών Επιστημών. Η διδακτορική της διατριβή' +
              ' εκπονήθηκε στο ίδιο Τμήμα και είχε θέμα «Εφαρμογές ασαφούς λογικής στη μέτρηση των στάσεων». Έχει συνεργαστεί με το Πάντειο Πανεπιστήμιο, το Εθνικό Κέντρο' +
              ' Κοινωνικών Ερευνών (ΕΚΚ Ε), το Κέντρο Ερευνών για Θέματα Ισότητας (ΚΕΘΙ) και το Εθνικό Ινστιτούτο Εργασίας και Ανθρώπινου Δυναμικού (ΕΙΕΑΔ). Επίσης, έχει' +
              ' εργαστεί, ως επιστημονική συνεργάτιδα στο Υπουργείο Εργασίας, Κοινωνικής Ασφάλισης και Κοινωνικής Αλληλεγγύης. Τα ερευνητικά τ ης ενδιαφέροντα αφορούν τη μέτρηση' +
              ' των στάσεων, την Τεχνητή Νοημοσύνη, την Ασαφή λογική, τις οντολογίες, το σημασιολογικό ιστό, την απασχόληση και την αγορά εργασίας. Από το 2011 είναι μέλος του' +
              ' Διοικητικού Συμβουλίου της Επιστημονικής Εταιρείας Κοινωνικής Πολιτικής (ΕΕΚΠ).',
            'content/images/project-team/Kazani_photo_research_team.jpeg',
            false
          )}
          <Grid.Column mobile={5} only="mobile">

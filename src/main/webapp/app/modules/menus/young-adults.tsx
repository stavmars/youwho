        ...
        <Container>
          <Grid stackable>
            <Grid.Row columns={2}>
              ...
              <Grid.Column computer={5}>
                <p className="young-adults-page-text">
                  ...
                  συγκρίνει το προφίλ του -ης με τα συγκεντρωτικό αποτέλεσμα όσων είχαν ήδη συμπληρώσει το ερωτηματολόγιο. Τμήμα των
                  δεδομένων έχει ήδη αναρτηθεί στην πλατφόρμα <a href="https://socioscope.gr/dataset/youwho">Socioscope</a>, στην σχετική
                  θεματική.
                </p>
              </Grid.Column>
            </Grid.Row>
            <Grid.Row>
              <Grid.Column>
                <p className="young-adults-page-text">
                  Παρακάτω παρουσιάζονται συγκεντρωτικά τα συνολικά αποτελέσματα των προφιλ με βαση τα τρια συνθετικά δίπολα, όπως προέκυψαν
                  απο τις απαντήσεις των ερωτώμενων:
                </p>
              </Grid.Column>
            </Grid.Row>
          </Grid>

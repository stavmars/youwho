    ...
    return (
      <Container className="project-page">
        ...
        <div className="project-page-content">
          Το 2017 το Λεξικό της Οξφόρδης ανακήρυξε ως λέξη της χρονιάς την λέξη «youthquake». Ως «νεανικός σεισμός» ορίζεται κάθε σημαντική
          πολιτισμική, πολιτική ή κοινωνική μεταβολή που προκύπτει μέσα από τις ενέργειες ή την επίδραση των νέων ανθρώπων (
          <a href="https://en.oxforddictionaries.com/word-of-the-year/word-of-the-year-2017" target="_blank">
            link
          </a>
          ). Δεν χωρά συνεπώς αμφιβολία ότι η δεύτερη δεκαετία του 21ου αιώνα συνοδεύεται από ένα αυξανόμενο ενδιαφέρον για τους νέους ως
          αντικείμενο μελέτης. Ιδιαίτερα μετά το ξέσπασμα της παγκόσμιας χρηματοπιστωτικής κρίσης το 2008 και τις καταγραφόμενες
          κοινωνικο-δημογραφικές μεταβολές στην νέες ηλικίες (την πρώτη γενιά ιστορικά που συνδυάζει υψηλό μορφωτικό επίπεδο με υψηλή
          ανεργία και απορρύθμιση των εργασιακών της σχέσεων) η επιστημονική έρευνα στρέφει το βλέμμα της στους νέους με ανανεωμένο
          ενδιαφέρον.
        </div>
        <br />
        ...
        <p className="project-page-content">
          ...
          δημόσιο διάλογο που θα αφορά τα βασικά χαρακτηριστικά της νέας γενιάς, αλλά η αναγνώριση επιμέρους χαρακτηριστικών των νέων με μια

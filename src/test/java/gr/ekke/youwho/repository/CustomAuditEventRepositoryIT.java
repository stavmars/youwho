...
import gr.ekke.youwho.config.audit.AuditEventConverter;
import gr.ekke.youwho.domain.PersistentAuditEvent;
...
import static gr.ekke.youwho.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
